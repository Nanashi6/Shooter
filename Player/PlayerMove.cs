...
//эта строчка гарантирует что скрипт не завалится 
...
public class PlayerMove : MonoBehaviour
{
    ...
    //что бы эта переменная работала добавьте тэг "Ground" на поверхность земли
